...
#define OS_EVENT_NAME_SIZE        2 // 16    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */

#define OS_LOWEST_PRIO           31    /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS             2 //10    /* Max. number of event control blocks in your application      */
...
#define OS_FLAG_NAME_SIZE         2 //16    /*     Determine the size of the name of an event flag group    */
...
#define OS_TMR_CFG_NAME_SIZE      2 // 16    /*     Determine the size of a timer name                       */
